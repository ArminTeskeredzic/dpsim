...
void scenario_F_step_B_SP(String simName, Real timeStep, Real finalTime, Bool startFaultEvent, Bool endFaultEvent, Real startTimeFault, Real endTimeFault, Bool useVarResSwitch, Real cmdInertia_G1, Real cmdDamping_G1) {
...
void scenario_F_step_B_EMT(String simName, Real timeStep, Real finalTime, Bool startFaultEvent, Bool endFaultEvent, Real startTimeFault, Real endTimeFault, Bool useVarResSwitch, Real cmdInertia_G1, Real cmdDamping_G1) {
	// ----- POWERFLOW FOR INITIALIZATION -----
	Real timeStepPF = finalTime;
	Real finalTimePF = finalTime+timeStepPF;
	String simNamePF = simName + "_PF";
	...
	LOAD_aux_PF->setParameters(4e6 /*Real activePower W*/, 1.3e6 /*Real reactivePower*/, 
	...
	TR_aux_PF->connect({ BUS_load_PF, BUS_coal_PF});
	LOAD_aux_PF->connect({ BUS_load_PF });
	
	//line_GEN_coal_PF->connect({ BUS_gen_coal_PF, BUS_coal_PF});
	GEN_coal_PF->connect({ BUS_coal_PF });
	
	auto systemPF = SystemTopology(50, // das ist freq??
			SystemNodeList{BUS_gas_PF, BUS_b_PF, BUS_c_PF, BUS_coal_PF, BUS_load_PF},
			SystemComponentList{GEN_gas_PF, TR_gas_PF, TR1_bc_PF, TR_coal_PF, TR_aux_PF, LOAD_aux_PF, 
								 GEN_coal_PF});
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	GEN_gas_EMT->addGovernor(0.3 /*Real Ta 0.3*/, 12.0 /*Real Tb 7.0*/, 0.5 /*Real Tc 0.5*/, 0.3 /*0.33 Real Fa 0.3*/,
                     ...
                     0.3 /*Real Tsm 0.3*/,  (4.002401874232913e6 / 50e6)*1.35 /*Real Tm_init*/,
                       (4.002401874232913e6 / 50e6)*1.35 /*Real PmRef*/);
					//  (Real Ta, Real Tb, Real Tc, Real Fa,
                    //                       Real Fb, Real Fc, Real K, Real Tsr,
                    //                       Real Tsm, Real Tm_init, Real PmRef)
	//4.002589142073939
	...
	//GEN_gas_EMT->setInitialValues(4.002401874232913e6/50e6, -0.122457148620299e6/50e6, 1.0, 0, 4.002401874232913e6/50e6);
	...
	GEN_coal_EMT->addGovernor(0.3 /*Real Ta 0.3*/, 12.0 /*Real Tb 7.0*/, 0.5 /*Real Tc 0.5*/, 0.3 /*0.33 Real Fa 0.3*/,
                     0.3 /*0.065 Real Fb 0.3*/, 0.4 /*0.055 Real Fc 0.4*/, 20 /*Real K 20*/, 0.1 /*Real Tsr 0.1*/,
                     0.3 /*Real Tsm 0.3*/, 0.0 / 600e6 + 0.0001 /*Real Tm_init*/,
                     0.0 / 600e6 + 0.0001 /*Real PmRef*/);
					//  (Real Ta, Real Tb, Real Tc, Real Fa,
                    //                       Real Fb, Real Fc, Real K, Real Tsr,
                    //                       Real Tsm, Real Tm_init, Real PmRef)
	...
	// GEN_coal_EMT->attributeTyped<Real>("T_e")->set(0);
	// GEN_coal_EMT->attributeTyped<Real>("T_m")->set(0);
	
	// GEN_gas_EMT->attributeTyped<Real>("T_e")->set(4.002401874232913e6 / 50e6);
	// GEN_gas_EMT->attributeTyped<Real>("T_m")->set(4.002401874232913e6 / 50e6);
	//GEN_gas_EMT->initializeFromNodesAndTerminals(50);
	//GEN_coal_EMT->setInitialValues(0, 0, 0.9999, -0.010655169099854889, 0);
	...
	LOAD_aux_EMT->setParameters(CPS::Math::singlePhasePowerToThreePhase(4e6), 
	...
	// load_shunt_bus_b_EMT->setParameters(CPS::Math::singlePhasePowerToThreePhase((1.0*220000)*(1.0*220000)/(322698.9333)+2e6), 
	// CPS::Math::singlePhasePowerToThreePhase((1.0*220000)*(1.0*220000)/(3226.9893)+5e6), generic_model_B_A.Vnom);

	// auto load_shunt_bus_a_EMT = EMT::Ph3::RXLoad::make("shunt_SR_acb", Logger::Level::debug);
	// load_shunt_bus_a_EMT->setParameters(CPS::Math::singlePhasePowerToThreePhase((1.0*220000)*(1.0*220000)/(322698.9333)+2e6), 
	// CPS::Math::singlePhasePowerToThreePhase((1.0*220000)*(1.0*220000)/(3226.9893)+5e6), generic_model_B_A.Vnom);
	...
	CPS::Math::singlePhasePowerToThreePhase((1.0*220000)*(1.0*220000)/(3226.9893)), generic_model_B_A.Vnom);
	...
	GEN_coal_EMT->connect({ BUS_coal_EMT });
	TR_aux_EMT->connect({ BUS_load_EMT, BUS_coal_EMT});
	...
	load_shunt_bus_b_EMT->connect({ BUS_shunt_b_EMT });
	...
	auto systemEMT = SystemTopology(50,
			SystemNodeList{BUS_gas_EMT, BUS_b_EMT, BUS_c_EMT, BUS_coal_EMT, BUS_load_EMT,
						BUS_shunt_b_EMT, BUS_a_EMT, BUS_psha_EMT},
			SystemComponentList{GEN_gas_EMT, TR_gas_EMT, TR1_bc_EMT, TR_coal_EMT, TR_aux_EMT, LOAD_aux_EMT, GEN_coal_EMT,
								breaker_bus_b_shunt_b_EMT, cable_EMT, load_shunt_bus_b_EMT, load_shunt_bus_a_EMT, line3_EMT});
	...
	if (startFaultEvent){
		...
		// simEMT.addEvent(sw2);
		// //GEN_coal_EMT->setInitialValues(2.8e6/600e6, 1.3e6/600e6, 1, 0, 2.8e6/600e6);
		// GEN_coal_EMT->attributeTyped<Real>("P_mech")->set(2.8e6/600e6);
		// GEN_coal_EMT->attributeTyped<Real>("P_elec")->set(2.8e6/600e6);
		// GEN_gas_EMT->attributeTyped<Real>("P_mech")->set(1.34e6/50e6);
		// GEN_gas_EMT->attributeTyped<Real>("P_elec")->set(1.34e6/50e6);
		//GEN_gas_EMT->setInitialValues(1.34e6/50e6, 0.03e6/50e6, 1, 0, 1.34e6/50e6);
	}
...
void scenario_F_step_B_DP(String simName, Real timeStep, Real finalTime, Bool startFaultEvent, Bool endFaultEvent, Real startTimeFault, Real endTimeFault, Bool useVarResSwitch, Real cmdInertia_G1, Real cmdDamping_G1) {
	// ----- POWERFLOW FOR INITIALIZATION -----
	Real timeStepPF = finalTime;
	Real finalTimePF = finalTime+timeStepPF;
	String simNamePF = simName + "_PF";
...
//Simultion parameters
	...
	scenario_F_step_B_EMT(simName, timeStep, finalTime, startFaultEvent, endFaultEvent, startTimeFault, endTimeFault, useVarResSwitch, cmdInertia_G1, cmdDamping_G1);
